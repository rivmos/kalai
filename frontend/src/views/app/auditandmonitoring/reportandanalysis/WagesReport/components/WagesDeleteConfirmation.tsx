...
const WagesDeleteConfirmation = () => {
    const dispatch = useAppDispatch()
    const dialogOpen = useAppSelector(
        (state) => state.reportsanalysisWagesList.data.deleteConfirmation
    )
    const selectedProduct = useAppSelector(
        (state) => state.reportsanalysisWagesList.data.selectedProduct
    )
...
export default WagesDeleteConfirmation
