...
import { apiDeleteArtist, apiDeleteArtwork, apiGetArtworks } from '@/services/ArtistService'
...
export const deleteArtwork = async (data: { id: string | string[] }) => {
    const response = await apiDeleteArtwork<
        boolean,
        { id: string | string[] }
    >(data)
    return response.data
