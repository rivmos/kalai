        ...
        <Card className='h-full'>
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                <div className="flex xl:flex-col items-center gap-4">
                    <Avatar size={90} shape="circle" src={data.photo} />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4 mt-8">
                    ...
                    <CustomerInfoField
                        title="Date of birth"
                        value={dayjs(data.DOB).format('DD-MM-YY')}
                    />
                    <CustomerInfoField
                        title="Location"
                    ...
                    <CustomerInfoField
                        title="Experience"
                        value={data.totalYearExp as string}
                    />
                    <CustomerInfoField
                        title="Published Rate"
                        value={`$${String(((data?.currentSalary as number) / (22 * 8 * 80)).toFixed(1))}/hr`}
                    />
                    <CustomerInfoField
                        title="Joining Date"
                        value={dayjs(data.dateOfJoining).format('DD-MM-YY')}
                    />
                    <div className="mb-7">
                        <span>Social</span>
