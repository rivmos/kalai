    ...
    return (
        <>
            <div className='container mx-auto !py-28'>
                <h2 className="text-3xl font-bold uppercase text-center tracking-tight text-gray-700 sm:text-4xl">Artworks</h2>
                <p className='text-center mt-2 text-base'>Discover from a curated collection of works by renowned Indian artists</p>
                <div className='flex justify-center items-center'>

                <div className='grid grid-cols-4 gap-8 place-items-center place-items-center my-16'>
                    {
                    ['Majestic Creatures',
                    'Abstract',
                    'Cityscape',
                    ...
                    'Nature'].map((artwork, index) => {
                        return(
                            <div className='relative rounded-full overflow-hidden group cursor-pointer w-52 h-52'>
                ...
                <div className='flex justify-center'>
                    <Button variant='solid' className='!text-gray-800'>View All Artworks</Button>
                </div>
            </div>
        </>
    )
