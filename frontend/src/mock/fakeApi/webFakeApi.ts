...
export default function webFakeApi(server: Server, apiPrefix: string) {
    server.get(`${apiPrefix}/web/home/pricing`, (schema) => {
        return schema.db.pricingData
    })

    
    server.get(`${apiPrefix}/web/home/homePage`, (schema) => {
        return schema.db.homePageData
    })
