    ...
    return (
        <>
            ...
            {/* <div className="inner-footer">
                <h5>Solutions</h5>
                <ul>
                    <li><Link to='/web/offer/mobility'>Mobility</Link></li>
                    <li><Link to='/web/offer/websolutions'>Web Solutions</Link></li>
                    <li><Link to='/web/offer/digitalmarketing'>Digital Marketing</Link></li>
                    <li><Link to='/web/offer/design'>Design</Link></li>
                    <li><Link to='/web/offer/branding'>Branding</Link></li>
                    <li><Link to='/web/offer/buisnessintelligence'>Business Intelligence</Link></li>
                </ul>
                <ul className='footer-home-ul'>
                    <li><Link to='/'>Home</Link></li>
                    <li><Link to='/web/company/aboutus'>About us</Link></li>
                    <li><Link to='/web/company/blog'>Blog</Link></li>
                    <li><Link to='/web/catalogue/projectsandpods'>Project & Pods</Link></li>
                    <li><Link to='/web/catalogue/pricing'>Pricing</Link></li>
                </ul>
                <div className="cpy-right">
                    <div className="txt">
                        <p>&copy; {`${new Date().getFullYear()}`}{' '} <span className="font-semibold">{`${APP_NAME}`}</span>{' '}</p>
                        <ul>
                            <li><Link to='/web/legal/pnp'>Privacy & Policy</Link></li>
                            <li><Link to='/web/legal/tnc'>Terms & Conditions</Link></li>
                            <li><Link to='/web/legal/help'>Help</Link></li>
                        </ul>
                    </div>
                    <div className="iconn">
            ...
            <div className="mx-auto w-full py-8 lg:py-12">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {new Date().getFullYear()} Uchaan Foundations. All Rights Reserved.
                    </span>
